...
export const SellingPriceSell = ({ orderbooks }: SellingPriceSellProps) => {
  ...
  return (
    <div>
        ...
        <div>
          {[...orderbooks.askLevels].reverse().map((data) => {
            ...
            return (
              <div
                key={`ask-${data.price}`}
                className="relative my-1 flex w-full justify-between text-[12px]"
              >
      ...
      <div className="mt-2 flex items-center justify-between rounded-xl border border-border-color border-opacity-20 p-2 px-8 text-[14px]">
